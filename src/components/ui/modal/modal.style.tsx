...
export const ModalStyled = styled.div`
  .alert {
    ...
    &-processing {
      box-shadow:
        -10px 0 10px -10px ${({ theme }) => theme.palette?.bg.highlight},
        0px 12px 32px 6px rgba(121, 138, 146, 0.2);
      border-left: 8px solid ${({ theme }) => theme.palette?.bg.highlight};

      svg {
        color: ${({ theme }) => theme.palette?.text.primaryInvert};
        animation-name: spin;
