    ...
    <FaqStyled>
      ...
      <div className="about">
        <div className="about-item">
          <p className="about-text">
            ...
            {' '}
            <b>Ski2 </b>
            <code>полное покрытие</code>
            {' '}
            /
            <b>xDream </b>
            <code>большинство триков</code>
            {' '}
            /
            <b>Aero </b>
            <code>в разработке</code>
            . Все возможные маршруты на данных картах можно посмотреть в
            резделе
            <a className="about-lint">/tricks</a>
            . Все трики делятся два типа с Pre-Strafe и
        ...
        <p className="about-text">
          ...
          <em>Pre-Strafe </em>
          {' '}
          - Начало трика обязательно начинается с места и отслеживание
          ...
          <strong> 405</strong>
          . Чтобы добиться такой скорости, нужно уметь делать специальный
        ...
        <p className="about-text">
          &emsp;
          <em>Unlimited </em>
          - Начало трика может быть с любого места и с не любой скоростью,
        ...
        <p className="about-text">
          ...
          разделах
          <a className="about-lint">/leaderboards</a>
          ...
          <code>!d / !daily</code>
          {' '}
          и выполнить достпуный трик, за это вы получите очки относительно
          ...
          <a className="about-lint">/trick-creator</a>
          , после провки модерацией данный трик будет
          опубликован.
        </p>
        <p className="about-text">
      ...
      <div className="commands">
        <p className="commands-text">
          &emsp;
          <code>!ski2 !strafes </code>
          {' '}
          - выбрать карту для отслеживания траекторий
        </p>
        <p className="commands-text">
          &emsp;
          <code>!saveloc !startpos </code>
          {' '}
          - сохранить свою позицию
        </p>
        <p className="commands-text">
          &emsp;
          <code>!teleport !tele !r !back </code>
          {' '}
          - телепорт к сохраненной позиции
        </p>
        <p className="commands-text">
          &emsp;
          <code>!mhud </code>
          {' '}
          - настройка худа со скоростью и отображением клавиш
        </p>
        <p className="commands-text">
          &emsp;
          <code>!triggers </code>
          <code>!t </code>
          {' '}
          - отображение касания триггеров
        </p>
        <p className="commands-text">
          &emsp;
          <code>!showtriggers </code>
          <code>!st </code>
          {' '}
          - отображение моделей триггеров
        </p>
        <p className="commands-text">
          &emsp;
          <code>!daily </code>
          <code>!d </code>
          {' '}
          - список ежедневных заданий-триков
        </p>
        <p className="commands-text">
          &emsp;
          <code>!skybox </code>
        ...
        <p className="commands-text">
          ...
          <code>!s </code>
          {' '}
          - получение скина за выполненные достижения
        </p>
        <p className="commands-text">
          &emsp;
          <code>!trickassist </code>
          <code>!ta </code>
          {' '}
          - отображение информации о касании триггеров при входе и выходе в чате
        </p>
        <p className="commands-text">
          &emsp;
          <code>!tah </code>
          {' '}
          - отображение информации о касании триггеров при входе и выходе
          на экране
        </p>
        <p className="commands-text">
          &emsp;
