...
declare global {
  ...
  const AppRoutes: typeof import('../../utils/router/index')['AppRoutes']
  ...
  const PortainerApi: (typeof import('../../utils/api/portainer'))['PortainerApi']
  const RootStore: typeof import('../../store/common/root-store')['RootStore']
  const Route: typeof import('react-router-dom')['Route']
  const Routes: typeof import('react-router-dom')['Routes']
  const THEME: typeof import('../../utils/common/constant')['THEME']
  const TOKEN_KEY: typeof import('../../utils/common/constant')['TOKEN_KEY']
  const TaskEvalutionKey: typeof import('../../utils/common/local-storage')['TaskEvalutionKey']
  const action: typeof import('mobx')['action']
  const api: typeof import('../../utils/api/endpoints/index')['api']
  const appStore: typeof import('../../store/app.store')['default']
  const applyInterceptor: typeof import('../../utils/api/helpers/instance')['applyInterceptor']
  const autorun: typeof import('mobx')['autorun']
  const axios: typeof import('axios')['default']
  const breakpoint: typeof import('../../utils/theme/emotion-theme')['breakpoint']
  const buildTree: (typeof import('../utils/common/tree-files'))['buildTree']
  ...
  const createMdWithExtension: typeof import('../../utils/common/helpers')['createMdWithExtension']
  ...
  const findFileInTree: (typeof import('../utils/common/tree-files'))['findFileInTree']
  ...
  const getFullImageUrl: typeof import('../../utils/common/get-full-image-url')['getFullImageUrl']
  const getId: typeof import('../../utils/common/utils')['getId']
  const getInstance: typeof import('../../utils/api/helpers/instance')['getInstance']
  ...
  const instance: (typeof import('../../utils/api/index'))['instance']
  const instances: typeof import('../../utils/api/endpoints/index')['instances']
  ...
  const portainerInstance: (typeof import('../../utils/api/index'))['portainerInstance']
  ...
  const setupBaseUrls: typeof import('../../utils/api/helpers/instance')['setupBaseUrls']
  ...
  const updateHeadersInstances: typeof import('../../utils/api/helpers/instance')['updateHeadersInstances']
  const urls: typeof import('../../utils/api/helpers/urls')['urls']
  ...
  const useSetMap: typeof import('../../hooks/user-set-map')['useSetMap']
